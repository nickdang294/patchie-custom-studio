...
export async function POST(request) {
  ...
  try {
    ...
    const {error}=await db.from('designs').insert({id,customer_name:name,size,mode,product_id:productId,product_price:productPrice,total_price:totalPrice,patches:mapped,note,image_path:path,status:'new',expires_at:expires});
