...
export default function Home(){
  ...
  const PatchGroupSelect=()=> <label className="patch-filter-select"><span>Nhóm patch</span><select value={activePatchGroup} onChange={e=>setActivePatchGroup(e.target.value)}>{patchGroups.map(g=><option key={g} value={g}>{g==='all'?'Tất cả':g} ({patchGroupCount(g)})</option>)}</select></label>;
