...
export default function Home(){
  ...
  const LoadingAnimation=()=> <section className="catalog-loading loading-card"><div className="loading-art" aria-hidden="true"><div className="loading-tote"><span>P</span></div><i className="loading-patch loading-patch-a">✦</i><i className="loading-patch loading-patch-b">♡</i><i className="loading-patch loading-patch-c">☀</i><i className="loading-patch loading-patch-d">✿</i><span className="loading-spark loading-spark-a">✧</span><span className="loading-spark loading-spark-b">✦</span></div><b>Đang dán chút đáng yêu lên shop…</b><p>Patchie đang gom sản phẩm base và mấy miếng patch xinh cho bạn.</p><div className="loading-dots" aria-label="Đang tải"><i></i><i></i><i></i></div></section>;
  if(!catalogReady)return <main className="shell" style={{'--patchie-font':brand.fontFamily}}><header className="topbar"><a className="brand" href="/"><BrandIdentity brand={brand}/></a><div className="toplinks"><span>Sản phẩm base · Patch thêu ủi</span><a href="/admin">Quản trị ↗</a></div></header><LoadingAnimation/></main>;
