...
export default function Home(){
  ...
  const brand={...BRAND_DEFAULTS,...(catalog.settings.brand||{}),productGroupImages:{...BRAND_DEFAULTS.productGroupImages,...(catalog.settings.brand?.productGroupImages||{})}};
  ...
  return <main className="shell" style={{'--patchie-font':brand.fontFamily}}><header className="topbar"><a className="brand" href="/"><BrandIdentity brand={brand}/></a><div className="toplinks"><span>{brand.slogan}</span><a href="/admin">Quản trị ↗</a></div></header>
