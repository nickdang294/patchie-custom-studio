...
export default function Home(){
  ...
  const productGroupOptions=PRODUCT_GROUPS.filter(g=>productsByGroup(g.value).length).map(g=>{const list=productsByGroup(g.value),first=list[0];return {value:g.value,label:g.label,sub:`${productBasesByGroup(g.value).length} mẫu`,image:productThumb(first)};});
